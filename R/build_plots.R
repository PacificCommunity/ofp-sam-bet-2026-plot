...
write_report_ready_figures_qmd <- function(figure_index, output_dir, ready_dir) {
  ...
  lines <- c(
    ...
    "",
    "<!--",
    "Auto-generated by the BET outputs task. Edit this file in the report repository to choose, remove, reorder, or rewrite figures.",
...
write_report_ready_tables_qmd <- function(table_index, ready_dir) {
  ...
  lines <- c(
    ...
    "",
    "<!--",
    "Auto-generated by the BET outputs task. Edit this file in the report repository to choose, remove, reorder, or rewrite tables.",
